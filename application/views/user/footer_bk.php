...
<div class="footer out-footer">
    <div class="copyright">
        <p>Copyright © Developed by <a href="https://globalconnex.com.au/" target="_blank">GlobalConnex</a> 2024</p>
    </div>
</div>
<!--**********************************
    Footer end
...
<script src="<?php echo base_url(); ?>others/cms/vendor/jquery-nice-select/js/jquery.nice-select.min.js"></script>
<script src="<?php echo base_url(); ?>others/cms/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
<script src="<?php echo base_url(); ?>others/cms/vendor/lightgallery/js/lightgallery-all.min.js"></script>
        ...
        if (e.target.files.length > 0) {
            ...
            for (let i = 0; i < e.target.files.length; i += 1) {
                ...
                <img src="${img}" alt="img"  title="${e.target.files[i].name}">
                    <div>
                    <span title="${e.target.files[i].name}"></span>
                    <br/>
                    <small></small>
                </div>
