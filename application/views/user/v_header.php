...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>User || <?php echo $MenuCall; ?></title>
    ...
    <link href="<?php echo base_url(); ?>others/cms/vendor/lightgallery/css/lightgallery.min.css" rel="stylesheet">
...
<!--                    <div class="img_cont">-->
<!--                        <img src="--><?php //echo base_url(); ?><!--others/cms/images/avatar/1.jpg" class="rounded-circle user_img" alt="">-->
        ...
        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <div class="header-info2 d-flex align-items-center">
                <div class="header-media">
                    <img src="<?php echo base_url(); ?>others/upload/user_photo/<?php echo $SessionData['user_image']; ?>" alt="">
                </div>
                <div class="header-info">
                    <h6><?php echo $SessionData['full_name']; ?></h6>
        ...
        <div class="dropdown-menu dropdown-menu-end" style="">
            <div class="card border-0 mb-0">
                <div class="card-header py-2">
                    <div class="products">
                        <img src="<?php echo base_url(); ?>others/upload/user_photo/<?php echo $SessionData['user_image']; ?>" class="avatar avatar-md" alt="">
                        <div>
                            <h6><?php echo $SessionData['full_name']; ?></h6>
                            <span><?php echo $SessionData['user_name']; ?></span>
                        </div>
                    </div>
                </div>
                <?php $SiteURLApplyStatus=site_url('user/apply_status'); ?>
                <div class="card-body px-0 py-2">
                    <a href="<?php echo $SiteURLApplyStatus; ?>" class="dropdown-item ai-icon ">
                ...
                <div class="card-footer px-0 py-2">
                    ...
                    <a href="<?php echo base_url(); ?>logout/user_logout" class="dropdown-item ai-icon">
