<section class="page-title" style="background-image: url(<?php echo base_url(); ?>others/images/background/page-title4.jpg);">
    <div class="auto-container">
        <div class="title-outer">
            <h4 style="color: white">Attachment List for Sweden Student Visa</h4>
        </div>
    </div>
</section>
...
<div class="row">
    ...
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Diploma Certificate-1 (If Applicable) :</label>
            <input class="form-control" type="file" name="DiplomaCertificate1" id="formFile" >
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Diploma Mark-sheet-1 (If Applicable) :</label>
            <input class="form-control" type="file" name="DiplomaMarkSheet1" id="formFile" >
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Diploma Certificate-2 (If Applicable) :</label>
            <input class="form-control" type="file" name="DiplomaCertificate2" id="formFile">
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Diploma Mark-sheet-2 (If Applicable)  :</label>
            <input class="form-control" type="file" name="DiplomaMarkSheet2" id="formFile" required >
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Training Certificate-1 (If Applicable) :</label>
            <input class="form-control" type="file" name="TrainingCertificate1" id="formFile">
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Training Certificate-2 (If Applicable  :</label>
            <input class="form-control" type="file" name="TrainingCertificate12" id="formFile">
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Skills Certificate -1 (If Applicable) :</label>
            <input class="form-control" type="file" name="SkillsCertificate1" id="formFile">
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Skills Certificate-2 (If Applicable) :</label>
            <input class="form-control" type="file" name="SkillsCertificate12" id="formFile">
        </div>
    </div>
    ...
    <div class="col-sm-3">
        <div class="mb-3">
            ...
            <input class="form-control" type="file" name="ELTSCertificate" id="formFile" required>
        </div>
    </div>
    ...
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Bank Statement (If Applicable) :</label>
            <input class="form-control" type="file" name="BankStatement" id="formFile">
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Bank Solvency (If Applicable) :</label>
            <input class="form-control" type="file" name="BankSolvency" id="formFile">
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Tuition Fees Transfer Receipt :</label>
            <input class="form-control" type="file" name="TuitionFeesTransferReceipt" id="formFile" required>
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Tuition Fees Transfer Bank Swift  :</label>
            <input class="form-control" type="file" name="TuitionFeesTransferBankSwift" id="formFile" required>
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Health Insurance Copy :</label>
            <input class="form-control" type="file" name="HealthInsuranceCopy" id="formFile" required>
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Proof of Accommodation(If Applicable) :</label>
            <input class="form-control" type="file" name="ProofAccommodation" id="formFile">
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
            <label class="lebel_title">Proof of Air Ticket Booking(If Applicable):</label>
            <input class="form-control" type="file" name="ProofAirTicketBooking" id="formFile">
        </div>
    </div>
    <div class="col-sm-3">
        <div class="mb-3">
