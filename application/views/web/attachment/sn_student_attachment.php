<section class="page-title" style="background-image: url(<?php echo base_url(); ?>others/images/background/page-title5.jpg);">
    <div class="auto-container">
        <div class="title-outer">
            <h4 style="color: white">Attachment List for Singapore Student Visa</h4>
        </div>
    </div>
</section>
...
<div class="col-sm-3">
    <div class="mb-3">
        <label class="lebel_title">NIC Card (If applicable) :</label>
        <input class="form-control" type="file" name="NIDCopy" id="formFile">
    </div>
</div>

<div class="col-sm-3">
    <div class="mb-3">
        <label class="lebel_title">Letter of Acceptance :</label>
        <input class="form-control" type="file" name="LetterAcceptance" id="formFile" required>
    </div>
</div>
...
<div class="col-sm-3">
    <div class="mb-3">
        <label class="lebel_title">Skills Certificate (If Applicable) :</label>
        <input class="form-control" type="file" name="SkillsCertificate" id="formFile">
    </div>
</div>
<div class="col-sm-3">
    <div class="mb-3">
...
<div class="col-sm-3">
    <div class="mb-3">
        ...
        <input class="form-control" type="file" name="OthersEnglishLanguageCertificate" id="formFile">
    </div>
</div>
<div class="col-sm-3">
    <div class="mb-3">
        <label class="lebel_title">Tuition fee Transfer Payment Receipt :</label>
        <input class="form-control" type="file" name="TuitionFeeTransferPayment" id="formFile" required>
    </div>
</div>
<div class="col-sm-3">
    <div class="mb-3">
        <label class="lebel_title">Tuition Fee Confirmation Letter  :</label>
        <input class="form-control" type="file" name="TuitionConfirmation" id="formFile" required>
    </div>
</div>
<div class="col-sm-3">
    <div class="mb-3">
...
<div class="col-sm-3">
    <div class="mb-3">
        ...
        <input class="form-control" type="file" name="VaccineCertificate" id="formFile">
    </div>
</div>
<div class="col-sm-3">
    <div class="mb-3">
        <label class="lebel_title">Work Experience Certificate (If Applicable):</label>
        <input class="form-control" type="file" name="WorkExperienceCertificate" id="formFile">
    </div>
</div>
<div class="col-sm-3">
    <div class="mb-3">
        <label class="lebel_title">Visa Application Form (ICA form 16) :</label>
        <input class="form-control" type="file" name="VisaApplicationFormICA16" id="formFile" required>
    </div>
</div>
<div class="col-sm-3">
    <div class="mb-3">
        <label class="lebel_title">Form V36 :</label>
        <input class="form-control" type="file" name="FormV36" id="formFile" required>
    </div>
</div>
