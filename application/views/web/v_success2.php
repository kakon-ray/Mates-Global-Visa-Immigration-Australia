...
<head>
    <meta charset="utf-8">
    <title>Global Connex | Visa & Immigrationse</title>
    ...
    <script src="<?php echo base_url(); ?>others/js/html5shiv.js"></script><![endif]-->
                ...
                <div class="col-xl-12">
                    <div class="error-page__inner">
                        <div class="error-page__title-box">
                            <img src="<?php echo base_url(); ?>others/images/success.png" width="200" height="200" alt="">
                            <h3 class="error-page__sub-title">SUCCESS</h3>
                        </div>
                        <p class="error-page__text">Your request has been successfully submit</p>
...
<!--                            </div>-->
<!--                        </form>-->
                        <?php $SiteURLHome=site_url('web/visitor_visa'); ?>
                        <a href="<?php echo $SiteURLHome; ?>" class="theme-btn btn-style-one shop-now"><span class="btn-title">Back to Home</span></a>
                    </div>
                </div>
            </div>
        </div>
