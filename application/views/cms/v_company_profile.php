...
<div class="content-body">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li><h5 class="bc-title">Company Profile</h5></li>
        </ol>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <?php
                            foreach($CompanyProfile as $CompanyProfileData)
                            {
                                $id=$CompanyProfileData['id'];
                                $title=$CompanyProfileData['title'];
                                $details=$CompanyProfileData['details'];
                            }
                            ?>
                            <?php $attributes = array('id' => '', 'class' => 'form-valide-with-icon needs-validation', 'enctype' =>'multipart/form-data');?>
                            <?php echo form_open_multipart('admin_oparetion/company_profile_update', $attributes);?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="8" cols="100" name="Details" class="form-control" required><?php echo $details ?></textarea>
                            </div>
