                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive active-projects style-1">
                            ...
                            <table id="empoloyees-tblwrapper" class="table-responsive">
                                ...
                                <?php
                                foreach($VisaMalaysia as $VisaMalaysiaData)
                                {
                                    $id=$VisaMalaysiaData['id'];
                                    $visa_category_id=$VisaMalaysiaData['visa_category_id'];
                                    ...
                                    $title=$VisaMalaysiaData['title'];
                                    $details=$VisaMalaysiaData['details'];
                                    $link=$VisaMalaysiaData['link'];
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $SiteURLCountryDele=site_url('admin_oparetion/visa_malaysia_delete/'.$id);
                                            $SiteURLEdit=site_url('cms/visa_malaysia_update/'.$id);
                                            ?>
...
<div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasExample">
    <div class="offcanvas-header">
        <h5 class="modal-title" id="#gridSystemModal">Add new visa items malaysia</h5>
    ...
    <div class="offcanvas-body">
        <div class="container-fluid">
            ...
            <?php echo form_open_multipart('admin_oparetion/cms_visa_malaysia', $attributes);?>
            <div class="row">
                <div class="mb-3">
