            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Immigration Service Update</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            foreach($Immigration as $ImmigrationData)
                            {
                                ...
                                $SapmleImageLink=base_url()."others/upload/home-service/".$image;
                            }
                            ?>
                            <?php $attributes = array('id' => '', 'class' => 'form-valide-with-icon needs-validation', 'enctype' =>'multipart/form-data');?>
                            <?php echo form_open_multipart('admin_oparetion/home_immigration_update', $attributes);?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="3" cols="40" name="Text" class="form-control" required><?php echo $text ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Image : <small>[Width:270px - Height:279px]</small></label>
