...
<div class="content-body">
    ...
    <div class="page-titles">
        <ol class="breadcrumb">
            <li><h5 class="bc-title">Apply for Visa</h5></li>
        </ol>
        <a class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">+ Add Items</a>
                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="table-responsive active-projects style-1">
                            ...
                            <table id="empoloyees-tblwrapper" class="table-responsive">
                                <thead>
                                <tr>
                                    <th>Category</th>
                                    <th>Title</th>
                                ...
                                <?php
                                foreach($VisaNewzealand as $VisaNewzealandData)
                                {
                                    $id=$VisaNewzealandData['id'];
                                    $visa_category_id=$VisaNewzealandData['visa_category_id'];
                                    foreach($VisaCategory as $VisaCategoryData)
                                    {
                                        if($VisaCategoryData['id']==$visa_category_id)
                                        {
                                            $category_name=$VisaCategoryData['category_name'];
                                        }
                                    }
                                    $title=$VisaNewzealandData['title'];
                                    $details=$VisaNewzealandData['details'];
                                    $link=$VisaNewzealandData['link'];
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $SiteURLCountryDele=site_url('admin_oparetion/visa_newzealand_delete/'.$id);
                                            $SiteURLEdit=site_url('cms/visa_newzealand_update/'.$id);
                                            ?>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="<?php echo $SiteURLEdit ?>">Edit</a>
                                                    <a class="dropdown-item" href="<?php echo $SiteURLCountryDele ?>">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasExample">
    <div class="offcanvas-header">
        <h5 class="modal-title" id="#gridSystemModal">Add new visa items New Zealand</h5>
    ...
    <div class="offcanvas-body">
        <div class="container-fluid">
            ...
            <?php echo form_open_multipart('admin_oparetion/cms_visa_newzealand', $attributes);?>
            <div class="row">
                <div class="mb-3">
                    <label class="form-label">Category Name :</label>
                    <select class="default-select  form-control wide" name="CategoryId" required>
                        <?php
                        foreach($VisaCategory as $VisaCategoryData)
                        {
                            $CategoryId=$VisaCategoryData['id'];
                            $CategoryName=$VisaCategoryData['category_name'];
                            ?>
                ...
                <div class="mb-3">
                    ...
                    <textarea rows="4" cols="50" name="Details" class="form-control" required></textarea>
                </div>
                <div class="mb-3">
                    <label class="form-label">Link :</label>
                    <input type="text" name="hrflink" class="form-control"  required>
                </div>
                <div class="mb-3">
