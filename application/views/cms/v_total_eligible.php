        ...
        <div class="col-xl-12">
            ...
            <div class="card dz-card" id="accordion-one">
                <div class="card-header flex-wrap">
                    <div>
                        <h4 class="card-title">Total Eligible <span class="badge badge-rounded badge-success"><?php echo $TotalEligible; ?></span></h4>
                    </div>
                </div>
                <!--tab-content-->
                    ...
                    <div class="tab-pane fade show active" id="Preview" role="tabpanel" aria-labelledby="home-tab">
                        <div class="card-body pt-0">
                            <div class="table-responsive">
                                <table id="example" class="display table" style="min-width: 90%; max-width: 90%;">
                                    <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Phone Number</th>
                                    ...
                                    <?php
                                    foreach($TodayApply as $TodayApplyData)
                                    {
                                        $form_id=$TodayApplyData['id'];
                                        $user_basic_id_form=$TodayApplyData['user_basic_id'];
                                        ...
                                        $status=$TodayApplyData['status'];
                                        if($status==0)
                                        {
                                            $eligibility="<span class=\"badge badge-danger light border-0\">Pending</span>";
                                        }
                                        else
                                        {
                                            $eligibility="<span class=\"badge badge-success light border-0\">Done</span>";
                                        }
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $student_visa_country; ?></td>
                                            <td class="text-center"><?php echo $eligibility;; ?></td>
                                            <td><?php echo $d_date; ?></td>
                                            <!--                                            <td>-->
                                            <!--                                                <a href="--><?php //echo $SiteURLFormView; ?><!--" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i>&nbsp;View</a>-->
                                            <!--                                                <a href="--><?php //echo $SiteURLFormDelete; ?><!--" class="btn btn-danger"><i class="fa-solid fa-trash"></i>&nbsp;Delete</a>-->
                                            <!--                                            </td>-->
                                            ...
                                            <td class="text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?php echo $SiteURLFormView; ?>"><i class="fa-solid fa-eye"></i>&nbsp;View</a>
                                                        <a class="dropdown-item" href="<?php echo $SiteURLAttachment; ?>"><i class="fa-solid fa-paperclip"></i>&nbsp;Attachment</a>
                                                        <a class="dropdown-item" href="<?php echo $SiteURLFormDelete; ?>"><i class="fa-solid fa-trash"></i>&nbsp;Delete</a></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
