                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Country&nbsp;Serve&nbsp;Malaysia&nbsp;Content&nbsp;Update</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <?php echo form_open_multipart('admin_oparetion/country_malaysia_update', $attributes);?>
                                <input type="hidden" name="Id" value="<?php echo $id; ?>">

                                <div class="mb-3">
                                    <label class="form-label">Text :</label>
                                    <textarea rows="15" cols="250" name="Text"  class="form-control" required><?php echo $text ?></textarea>
                                </div>
