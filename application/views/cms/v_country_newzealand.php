    ...
    ***********************************-->
    <div class="content-body">
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">Country&nbsp;Serve</h5></li>
            </ol>
        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Country&nbsp;Serve&nbsp;New&nbsp;Zealand&nbsp;Content&nbsp;Update</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <?php echo form_open_multipart('admin_oparetion/country_newzealand_update', $attributes);?>
                                <input type="hidden" name="Id" value="<?php echo $id; ?>">

                                <div class="mb-3">
                                    <label class="form-label">Text :</label>
                                    <textarea rows="10" cols="180" name="Text"  class="form-control" required><?php echo $text ?></textarea>
                                </div>
                                <div class="mb-3">
