...
<div class="content-body">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li><h5 class="bc-title">Video</h5></li>
        </ol>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <?php
                            foreach($CmsVideo as $CmsVideoData)
                            {
                                $id=$CmsVideoData['id'];
                                $image=$CmsVideoData['image'];
                                $text=$CmsVideoData['text'];
                                $explore_link=$CmsVideoData['explore_link'];
                                $video_link=$CmsVideoData['video_link'];
                                $phone=$CmsVideoData['phone'];

                                $SapmleImageLink=base_url()."others/upload/home-video/".$image;
                            }
                            ?>
                            <?php $attributes = array('id' => '', 'class' => 'form-valide-with-icon needs-validation', 'enctype' =>'multipart/form-data');?>
                            <?php echo form_open_multipart('admin_oparetion/cms_video_update', $attributes);?>
                            <input type="hidden" name="Id" value="<?php echo $id; ?>">
                            <div class="mb-3">
                                <label class="form-label">Text :</label>
                                <input type="text" name="Text" class="form-control" value="<?php echo $text ?>" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Explore Link :</label>
                                <input type="text" name="ExploreLink" class="form-control" value="<?php echo $explore_link ?>" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Video Link :</label>
                                <input type="text" name="VideoLink" class="form-control" value="<?php echo $video_link ?>" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Image : <small>[Width:1894px - Height:550px]</small></label>
                                ...
                                <div class="timeline_content_addon3">
                                    <img id="output" src="<?php echo $SapmleImageLink; ?>" width="100%" height="220px" />
                                </div>
                            </div>
