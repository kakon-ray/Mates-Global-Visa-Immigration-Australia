...
<div class="content-body">
    ...
    <div class="page-titles">
        ...
        <a class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">+ Add Category</a>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive active-projects style-1">
                            ...
                            <table id="empoloyees-tblwrapper" class="table-responsive">
                                ...
                                {
                                    $id=$VisaCategoryData['id'];
                                    $category_name=$VisaCategoryData['category_name'];
                                    $country=$VisaCategoryData['country'];
                                    $d_date=$VisaCategoryData['d_date'];
                                    $d_time=$VisaCategoryData['d_time'];
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><span><?php echo $d_time; ?></span></td>
                                        <td>
                                            <?php
                                            $SiteURLCountryDele=site_url('admin_oparetion/visa_category_delete/'.$id);
                                            $SiteURLEdit=site_url('cms/visa_category_update/'.$id);
                                            ?>
...
<div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasExample">
    <div class="offcanvas-header">
        <h5 class="modal-title" id="#gridSystemModal">Add New Visa Category</h5>
    ...
    <div class="offcanvas-body">
        <div class="container-fluid">
            ...
            <?php echo form_open_multipart('admin_oparetion/cms_visa_category', $attributes);?>
            <div class="row">
                <div class="mb-3">
