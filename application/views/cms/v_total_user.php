        ...
        <div class="col-xl-12">
            ...
            <div class="card dz-card" id="accordion-one">
                <div class="card-header flex-wrap">
                    <div>
                        <h4 class="card-title">Total User <span class="badge badge-rounded badge-success"><?php echo $TotalEligible; ?></span></h4>
                    </div>
                </div>
                <!--tab-content-->
                    ...
                    <div class="tab-pane fade show active" id="Preview" role="tabpanel" aria-labelledby="home-tab">
                        <div class="card-body pt-0">
                            <div class="table-responsive">
                                <table id="example" class="display table" style="min-width: 93%; max-width: 98%;">
                                    <thead>
                                    <tr>
                                        <th>SL</th>
                                        <th>Name</th>
                                    ...
                                    <?php
                                    $sl=1;
                                    foreach($TotalUser as $TotalUserData)
                                    {
                                        $user_basic_id=$TotalUserData['id'];
                                        $user_email=$TotalUserData['user_name'];
                                        $user_full_name=$TotalUserData['full_name'];
                                        $user_image=$TotalUserData['user_image'];
                                        $user_status=$TotalUserData['status'];
                                        foreach($AssessmentRequest as $AssessmentRequestData)
                                        {
                                            if($AssessmentRequestData['user_basic_id']==$user_basic_id)
                                            {
                                                $phone_number=$AssessmentRequestData['phone_number'];
                                                $contact_address=$AssessmentRequestData['contact_address'];
                                            }
                                        }

                                        $user_pic_url=base_url()."others/upload/user_photo/$user_image";

                                        if($user_status==1)
                                        {
                                            $user_status_value="<span class=\"badge badge-success light border-0\">Active</span>";
                                        }
                                        else
                                        {
                                            $user_status_value="<span class=\"badge badge-danger light border-0\">Inactive</span>";
                                        }
//                                        $SiteURLFormView=site_url('cms/form_view/'.$form_id);
//                                        $SiteURLFormDownload=site_url('cms/form_download/'.$form_id);
//                                        $SiteURLAttachment=site_url('cms/attachment_view/'.$user_basic_id_form);
//                                        $SiteURLFormDelete=site_url('admin_oparetion/form_delete/'.$user_basic_id_form);
                                        ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                $arr = explode (" " , $contact_address);
                                                $lines = array_chunk($arr,2);
                                                foreach($lines as $line)
                                                    echo implode (" ", $line)."<br>";
                                                ?>
                                            </td>
                                            <td>
                                                <img src="<?php echo $user_pic_url; ?>" class="avatar avatar-md" alt="">
                                            </td>
                                            <td><?php echo $user_status_value; ?></td>
                                            <td class="text-left">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#"><i class="fa-solid fa-eye"></i>&nbsp;User&nbsp;Details</a>
                                                        <a class="dropdown-item" href="#"><i class="fa-solid fa-trash"></i>&nbsp;Inactive</a></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
