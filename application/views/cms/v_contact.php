                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <?php
                            foreach($CmsContact as $CmsContactData)
                            {
                                $id=$CmsContactData['id'];
                                $address=$CmsContactData['address'];
                                $email=$CmsContactData['email'];
                                $phone=$CmsContactData['phone'];
                            }
                            ?>
                            <?php $attributes = array('id' => '', 'class' => 'form-valide-with-icon needs-validation', 'enctype' =>'multipart/form-data');?>
                            <?php echo form_open_multipart('admin_oparetion/cms_contact_update', $attributes);?>
