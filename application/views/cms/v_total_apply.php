...
<div class="card-header flex-wrap">
    <div>
        <h4 class="card-title">Today Apply</h4>
    </div>
</div>
<!--tab-content-->
...
<table id="example" class="display table" style="min-width: 100%;">
<thead>
<tr>
    <th>ID</th>
    <th>Name</th>
...
<?php
  foreach($TotalApply as $TodayApplyData)
  {
      $form_id=$TodayApplyData['id'];
      $full_name=$TodayApplyData['full_name'];
      $date_of_birth=$TodayApplyData['date_of_birth'];
      $gender=$TodayApplyData['gender'];
      $nationality=$TodayApplyData['nationality'];
      $father_name=$TodayApplyData['father_name'];
      $mother_name=$TodayApplyData['mother_name'];
