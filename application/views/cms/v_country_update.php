            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Country Offer Update</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            foreach($CmsCountry as $CmsCountryData)
                            {
                                ...
                                $country_image=$CmsCountryData['country_image'];
                                $country_name=$CmsCountryData['country_name'];
                                $details=$CmsCountryData['details'];
                                $SapmleImageLink=base_url()."others/upload/country/".$country_image;
                            }
                            ?>
                            <?php $attributes = array('id' => '', 'class' => 'form-valide-with-icon needs-validation', 'enctype' =>'multipart/form-data');?>
                            <?php echo form_open_multipart('admin_oparetion/home_country_update', $attributes);?>
                            <input type="hidden" name="Id" value="<?php echo $id; ?>">
                            <div class="mb-3">
                                <label class="form-label">Country Name :</label>
                                <input type="text" name="CountryName" class="form-control" value="<?php echo $country_name ?>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Image : <small>[Width:200px - Height:200px]</small></label>
                                ...
                                <input type="hidden" name="Image" value="<?php echo $country_image; ?>">
                            </div>
