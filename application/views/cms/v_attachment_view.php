...
<div class="tbl-caption">
    <h4 class="heading mb-0"><?php echo $full_name; ?>&nbsp;<i class="fa-solid fa-arrow-right"></i>&nbsp;Attachments</h4>
    <div>
        <style>
...
<div class="table-responsive">
    <table class="table table-responsive-md">
        ...
        foreach($Attachment as $AttachmentData)
        {
            ...
            if($cover_letter=="")
            {
                $cover_letter_file_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $cover_letter_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkCoverLetter=base_url().'cms'.'/'.'attachment_download_single'.'/'.$cover_letter;
                $cover_letter_download='<a href='.$attachment_file=$DownloadLinkCoverLetter.' class="buttonDownload">Download</a>';
            }
            /*************cover_letter***********/
            ...
            if($cv=="")
            {
                $cv_file_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $cv_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkCv=base_url().'cms'.'/'.'attachment_download_single'.'/'.$cv;
                $cv_download='<a href='.$attachment_file=$DownloadLinkCv.' class="buttonDownload">Download</a>';
            }
            /*************CV***********/
            ...
            if($job_ex_letter=="")
            {
                $job_ex_letter_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $job_ex_letter_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkJobExLetter=base_url().'cms'.'/'.'attachment_download_single'.'/'.$job_ex_letter;
                $job_ex_letter_download='<a href='.$attachment_file=$DownloadLinkJobExLetter.' class="buttonDownload">Download</a>';
            }
            /*************job_ex_letter***********/
            ...
            {
                $employment_letter_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $employment_letter_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkEmploymentLetter=base_url().'cms'.'/'.'attachment_download_single'.'/'.$employment_letter;
                $employment_letter_download='<a href='.$attachment_file=$DownloadLinkEmploymentLetter.' class="buttonDownload">Download</a>';
            }
            /*************employment_letter***********/

            /*************ielts_pte_certificate***********/
             $ielts_pte_certificate=$AttachmentData['ielts_pte_certificate'];
            if($ielts_pte_certificate=="")
            {
                $ielts_pte_certificate_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $ielts_pte_certificate_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkIeltsPteCertificate=base_url().'cms'.'/'.'attachment_download_single'.'/'.$ielts_pte_certificate;
                $ielts_pte_certificate_download='<a href='.$attachment_file=$DownloadLinkIeltsPteCertificate.' class="buttonDownload">Download</a>';
            }
            /*************ielts_pte_certificate***********/

            /*************masters_certificate***********/
            $masters_certificate=$AttachmentData['masters_certificate'];
            if($masters_certificate=="")
            {
                $masters_certificate_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $masters_certificate_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkMastersCertificate=base_url().'cms'.'/'.'attachment_download_single'.'/'.$masters_certificate;
                $masters_certificate_download='<a href='.$attachment_file=$DownloadLinkMastersCertificate.' class="buttonDownload">Download</a>';
            }
            ...
            if($masters_mark_sheet=="")
            {
                $masters_mark_sheet_show= "<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $masters_mark_sheet_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkMastersMarkSheet=base_url().'cms'.'/'.'attachment_download_single'.'/'.$masters_mark_sheet;
                $masters_mark_sheet_download='<a href='.$attachment_file=$DownloadLinkMastersMarkSheet.' class="buttonDownload">Download</a>';
            }
            /*************masters_mark_sheet***********/
            ...
            {
                $graduate_certificate_show= "<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $graduate_certificate_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkGraduateCertificate=base_url().'cms'.'/'.'attachment_download_single'.'/'.$graduate_certificate;
                $graduate_certificate_download='<a href='.$attachment_file=$DownloadLinkGraduateCertificate.' class="buttonDownload">Download</a>';
            }
            /*************graduate_certificate***********/

            /*************graduate_mark_sheet***********/
            $graduate_mark_sheet=$AttachmentData['graduate_mark_sheet'];
            if($graduate_mark_sheet=="")
            {
                $graduate_mark_sheet_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $graduate_mark_sheet_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkGraduateMarkSheet=base_url().'cms'.'/'.'attachment_download_single'.'/'.$graduate_mark_sheet;
                $graduate_mark_sheet_download='<a href='.$attachment_file=$DownloadLinkGraduateMarkSheet.' class="buttonDownload">Download</a>';
            }
            /*************graduate_mark_sheet***********/
            ...
            {
                $diploma_certificate_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $diploma_certificate_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkDiplomaCertificate=base_url().'cms'.'/'.'attachment_download_single'.'/'.$diploma_certificate;
                $diploma_certificate_download='<a href='.$attachment_file=$DownloadLinkDiplomaCertificate.' class="buttonDownload">Download</a>';
            }
            /*************diploma_certificate***********/

            /*************diploma_mark_sheet***********/
            $diploma_mark_sheet=$AttachmentData['diploma_mark_sheet'];
            if($diploma_mark_sheet=="")
            {
                $diploma_mark_sheet_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $diploma_mark_sheet_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkDiplomaMarkSheet=base_url().'cms'.'/'.'attachment_download_single'.'/'.$diploma_mark_sheet;
                $diploma_mark_sheet_download='<a href='.$attachment_file=$DownloadLinkDiplomaMarkSheet.' class="buttonDownload">Download</a>';
            }
            /*************diploma_mark_sheet***********/

            /*************skilled_certificate***********/
            $skilled_certificate=$AttachmentData['skilled_certificate'];
            if($skilled_certificate=="")
            {
                $skilled_certificate_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $skilled_certificate_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkSkilledCertificate=base_url().'cms'.'/'.'attachment_download_single'.'/'.$skilled_certificate;
                $skilled_certificate_download='<a href='.$attachment_file=$DownloadLinkSkilledCertificate.' class="buttonDownload">Download</a>';
            }
            /*************skilled_certificate***********/
            ...
            if($hsc_certificate=="")
            {
                $hsc_certificate_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $hsc_certificate_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkHscCertificate=base_url().'cms'.'/'.'attachment_download_single'.'/'.$hsc_certificate;
                $hsc_certificate_download='<a href='.$attachment_file=$DownloadLinkHscCertificate.' class="buttonDownload">Download</a>';
            }
            /*************hsc_certificate***********/
            ...
            if($hsc_mark_sheet=="")
            {
                $hsc_mark_sheet_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $hsc_mark_sheet_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkHscMarkSheet=base_url().'cms'.'/'.'attachment_download_single'.'/'.$hsc_mark_sheet;
                $hsc_mark_sheet_download='<a href='.$attachment_file=$DownloadLinkHscMarkSheet.' class="buttonDownload">Download</a>';
            }
            /*************hsc_mark_sheet***********/
            ...
            if($ssc_certificate=="")
            {
                $ssc_certificate_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $ssc_certificate_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkSscCertificate=base_url().'cms'.'/'.'attachment_download_single'.'/'.$ssc_certificate;
                $ssc_certificate_download='<a href='.$attachment_file=$DownloadLinkSscCertificate.' class="buttonDownload">Download</a>';
            }
            /*************ssc_certificate***********/
            ...
            if($ssc_mark_sheet=="")
            {
                $ssc_mark_sheet_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $ssc_mark_sheet_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkSscMarkSheet=base_url().'cms'.'/'.'attachment_download_single'.'/'.$ssc_mark_sheet;
                $ssc_mark_sheet_download='<a href='.$attachment_file=$DownloadLinkSscMarkSheet.' class="buttonDownload">Download</a>';
            }
            ...
            if($passport_copy=="")
            {
                $passport_copy_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $passport_copy_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkPassportCopy=base_url().'cms'.'/'.'attachment_download_single'.'/'.$passport_copy;
                $passport_copy_download='<a href='.$attachment_file=$DownloadLinkPassportCopy.' class="buttonDownload">Download</a>';
            }
            /*************passport_copy***********/
            ...
            {
                $birth_certificate_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $birth_certificate_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                ...
                $DownloadLinkBirthCertificate=base_url().'cms'.'/'.'attachment_download_single'.'/'.$birth_certificate;
                $birth_certificate_download='<a href='.$attachment_file=$DownloadLinkBirthCertificate.' class="buttonDownload">Download</a>';
            }
            /*************birth_certificate***********/

            /*************police_clearance_ov***********/
            $police_clearance_ov=$AttachmentData['police_clearance_ov'];
            if($police_clearance_ov=="")
            {
                $police_clearance_ov_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $police_clearance_ov_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                $file_url_police_clearance_ov=base_url().'others/upload/student_visa_attachment/'.$police_clearance_ov;
                $path_police_clearance_ov = parse_url($file_url_police_clearance_ov, PHP_URL_PATH);
                ...
                {
                    $police_clearance_ov_show="<i class=\"fa-regular fa-image\"></i>&nbsp;"."Police Clearance Certificate(Overseas).".$extension_police_clearance_ov;
                }
                elseif($extension_police_clearance_ov == 'pdf')
                {
                    $police_clearance_ov_show="<i class=\"fa-solid fa-file-pdf\"></i>&nbsp;"."Police Clearance Certificate(Overseas).".$extension_police_clearance_ov;
                }
                elseif($extension_police_clearance_ov == 'doc' || $extension_police_clearance_ov == 'docx')
                {
                    $police_clearance_ov_show="<i class=\"fa-regular fa-file-word\"></i>&nbsp;"."Police Clearance Certificate(Overseas).".$extension_police_clearance_ov;
                }
                $DownloadLinkPoliceClearanceOv=base_url().'cms'.'/'.'attachment_download_single'.'/'.$police_clearance_ov;
                $police_clearance_ov_download='<a href='.$attachment_file=$DownloadLinkPoliceClearanceOv.' class="buttonDownload">Download</a>';
            }
            /*************police_clearance_ov***********/

            /*************police_clearance_bd***********/
            $police_clearance_bd=$AttachmentData['police_clearance_bd'];
            if($police_clearance_bd=="")
            {
                $police_clearance_bd_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $police_clearance_bd_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                $file_url_police_clearance_bd=base_url().'others/upload/student_visa_attachment/'.$police_clearance_bd;
                $path_police_clearance_bd = parse_url($file_url_police_clearance_bd, PHP_URL_PATH);
                ...
                {
                    $police_clearance_bd_show="<i class=\"fa-regular fa-image\"></i>&nbsp;"."Police Clearance Certificate (BD).".$extension_police_clearance_bd;
                }
                elseif($extension_police_clearance_bd == 'pdf')
                {
                    $police_clearance_bd_show="<i class=\"fa-solid fa-file-pdf\"></i>&nbsp;"."Police Clearance Certificate (BD).".$extension_police_clearance_bd;
                }
                elseif($extension_police_clearance_bd == 'doc' || $extension_police_clearance_bd == 'docx')
                {
                    $police_clearance_bd_show="<i class=\"fa-regular fa-file-word\"></i>&nbsp;"."Police Clearance Certificate (BD).".$extension_police_clearance_bd;
                }
                $DownloadLinkPoliceClearanceBd=base_url().'cms'.'/'.'attachment_download_single'.'/'.$police_clearance_bd;
                $police_clearance_bd_download='<a href='.$attachment_file=$DownloadLinkPoliceClearanceBd.' class="buttonDownload">Download</a>';
            }
            /*************police_clearance_bd***********/

            /*************covid_certificate_ov***********/
            $covid_certificate_ov=$AttachmentData['covid_certificate_ov'];
            if($covid_certificate_ov=="")
            {
                $covid_certificate_ov_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $covid_certificate_ov_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                $file_url_covid_certificate_ov=base_url().'others/upload/student_visa_attachment/'.$covid_certificate_ov;
                $path_covid_certificate_ov = parse_url($file_url_covid_certificate_ov, PHP_URL_PATH);
                ...
                {
                    $covid_certificate_ov_show="<i class=\"fa-regular fa-image\"></i>&nbsp;"."Covid Certificate(Overseas).".$extension_covid_certificate_ov;
                }
                elseif($extension_covid_certificate_ov == 'pdf')
                {
                    $covid_certificate_ov_show="<i class=\"fa-solid fa-file-pdf\"></i>&nbsp;"."Covid Certificate(Overseas).".$extension_covid_certificate_ov;
                }
                elseif($extension_covid_certificate_ov == 'doc' || $extension_covid_certificate_ov == 'docx')
                {
                    $covid_certificate_ov_show="<i class=\"fa-regular fa-file-word\"></i>&nbsp;"."Covid Certificate(Overseas).".$extension_covid_certificate_ov;
                }
                $DownloadLinkCovidCertificateOv=base_url().'cms'.'/'.'attachment_download_single'.'/'.$covid_certificate_ov;
                $covid_certificate_ov_download='<a href='.$attachment_file=$DownloadLinkCovidCertificateOv.' class="buttonDownload">Download</a>';
            }
            /*************covid_certificate_ov***********/

            /*************covid_certificate_bd***********/
            $covid_certificate_bd=$AttachmentData['covid_certificate_bd'];
            if($covid_certificate_bd=="")
            {
                $covid_certificate_bd_show="<span class=\"badge light badge-danger\">Attachment not submitted</span>";
                $covid_certificate_bd_download="<span class=\"badge light badge-danger\">File not found</span>";
            }
            else
            {
                $file_url_covid_certificate_bd=base_url().'others/upload/student_visa_attachment/'.$covid_certificate_bd;
                $path_covid_certificate_bd = parse_url($file_url_covid_certificate_bd, PHP_URL_PATH);
                ...
                {
                    $covid_certificate_bd_show="<i class=\"fa-regular fa-image\"></i>&nbsp;"."Covid Certificate(BD).".$extension_covid_certificate_bd;
                }
                elseif($extension_covid_certificate_bd == 'pdf')
                {
                    $covid_certificate_bd_show="<i class=\"fa-solid fa-file-pdf\"></i>&nbsp;"."Covid Certificate(BD).".$extension_covid_certificate_bd;
                }
                elseif($extension_covid_certificate_bd == 'doc' || $extension_covid_certificate_bd == 'docx')
                {
                    $covid_certificate_bd_show="<i class=\"fa-regular fa-file-word\"></i>&nbsp;"."Covid Certificate(BD).".$extension_covid_certificate_bd;
                }
                $DownloadLinkCovidCertificateBd=base_url().'cms'.'/'.'attachment_download_single'.'/'.$covid_certificate_bd;
                $covid_certificate_bd_download='<a href='.$attachment_file=$DownloadLinkCovidCertificateBd.' class="buttonDownload">Download</a>';
            }
            /*************covid_certificate_bd***********/
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  <?php echo $cover_letter_download; ?>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <?php echo $job_ex_letter_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $employment_letter_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                   <?php echo $ielts_pte_certificate_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                   <?php echo $masters_certificate_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $masters_mark_sheet_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $graduate_certificate_download ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                   <?php echo $graduate_mark_sheet_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $diploma_certificate_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $diploma_mark_sheet_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $skilled_certificate_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                  <?php echo $hsc_certificate_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $hsc_mark_sheet_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $ssc_certificate_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $ssc_mark_sheet_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $passport_copy_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php echo $birth_certificate_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" class="form-check-input"  name="police_clearance_ov" value="<?php echo $police_clearance_ov; ?>" id="customCheckBox1" required>
                </td>
                <td>
                    <span>Police Clearance Certificate (Overseas)</span>
                </td>
                <td>
                    <a onclick="togglePopup('<?php echo $extension_police_clearance_ov; ?>', '<?php echo $file_url_police_clearance_ov; ?>')" href="#" class="text-body">
                        <?php echo $police_clearance_ov_show; ?>
                    </a>
                </td>
                <td>
                    <span><?php echo $student_visa_country; ?></span>
                ...
                <td>
                    <?php echo $police_clearance_ov_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" class="form-check-input"  name="police_clearance_bd" value="<?php echo $police_clearance_bd; ?>" id="customCheckBox1" required>
                </td>
                <td>
                    <span>Police Clearance Certificate (BD)</span>
                </td>
                <td>
                    <a onclick="togglePopup('<?php echo $extension_police_clearance_bd; ?>', '<?php echo $file_url_police_clearance_bd; ?>')" href="#" class="text-body">
                        <?php echo $police_clearance_bd_show; ?>
                    </a>
                </td>
                <td>
                    <span><?php echo $student_visa_country; ?></span>
                ...
                <td>
                   <?php echo $police_clearance_bd_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" class="form-check-input"  name="covid_certificate_ov" value="<?php echo $covid_certificate_ov; ?>" id="customCheckBox1" required>
                </td>
                <td>
                    <span>Covid Certificate (Overseas)</span>
                </td>
                <td>
                    <a onclick="togglePopup('<?php echo $extension_covid_certificate_ov; ?>', '<?php echo $file_url_covid_certificate_ov; ?>')" href="#" class="text-body">
                        <?php echo $covid_certificate_ov_show; ?>
                    </a>
                </td>
                <td>
                    <span><?php echo $student_visa_country; ?></span>
                ...
                <td>
                   <?php echo $covid_certificate_ov_download; ?>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" class="form-check-input"  name="covid_certificate_bd" value="<?php echo $covid_certificate_bd; ?>" id="customCheckBox1" required>
                </td>
                <td>
                    <span>Covid Certificate (BD)</span>
                </td>
                <td>
                    <a onclick="togglePopup('<?php echo $extension_covid_certificate_bd; ?>', '<?php echo $file_url_covid_certificate_bd; ?>')" href="#" class="text-body">
                        <?php echo $covid_certificate_bd_show; ?>
                    </a>
                </td>
                <td>
                    <span><?php echo $student_visa_country; ?></span>
                ...
                <td>
                    <?php echo $covid_certificate_bd_download; ?>
                </td>
            </tr>
...
<?php
 ...
 ?>
     <div class="alert alert-secondary solid alert-dismissible fade show">
         ...
         <strong>Sorry!</strong> No attachment data found of&nbsp;<?php echo $full_name; ?>&nbsp;user.
