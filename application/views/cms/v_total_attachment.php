        ...
        <div class="col-xl-12">
            ...
            <div class="card dz-card" id="accordion-one">
                <div class="card-header flex-wrap">
                    <div>
                        <h4 class="card-title">User Attachment <span class="badge badge-rounded badge-success"><?php echo $TotalAttachment; ?></span></h4>
                    </div>
                </div>
                <!--tab-content-->
                    ...
                    <div class="tab-pane fade show active" id="Preview" role="tabpanel" aria-labelledby="home-tab">
                        <div class="card-body pt-0">
                            <div class="table-responsive">
                                <table id="example" class="display table" style="min-width: 90%; max-width: 98%;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Visa Category</th>
                                        <th class="text-center">Total Attachment</th>
                                        <th class="text-center">Submitted (Date | Time)</th>
                                    ...
                                    <?php
                                    $sl=1;
                                      foreach($Attachments as $AttachmentsData)
                                      {
                                          $student_visa_attachment_id=$AttachmentsData['id'];
                                          $attachment_user_basic_id=$AttachmentsData['user_basic_id'];
                                          $user_basic_id_form=$attachment_user_basic_id;
                                          $SiteURLAttachment=site_url('cms/attachment_view/'.$user_basic_id_form);
                                          $SiteURLAttachmentDelete=site_url('cms/attachment_delete/'.$student_visa_attachment_id);

                                          foreach($Assessment as $AssessmentData)
                                          {
                                              if($AssessmentData['user_basic_id']==$attachment_user_basic_id)
                                              {
                                                  $fullname=$AssessmentData['fullname'];
                                                  $phone_number=$AssessmentData['phone_number'];
                                                  $email=$AssessmentData['email'];
                                              }

                                          }
                                          $cover_letter=$AttachmentsData['cover_letter'];
                                          if($cover_letter=="")
                                          {
                                          ...
                                          $job_ex_letter=$AttachmentsData['job_ex_letter'];
                                          if($job_ex_letter=="")
                                          {
                                              $job_ex_letter_count=0;
                                          }
                                          else
                                          {
                                              $job_ex_letter_count=1;
                                          }
                                          $employment_letter=$AttachmentsData['employment_letter'];
                                          if($employment_letter=="")
                                          {
                                              $employment_letter_count=0;
                                          }
                                          else
                                          {
                                              $employment_letter_count=1;
                                          }
                                          $ielts_pte_certificate=$AttachmentsData['ielts_pte_certificate'];
                                          if($ielts_pte_certificate=="")
                                          {
                                              $ielts_pte_certificate_count=0;
                                          }
                                          else
                                          {
                                              $ielts_pte_certificate_count=1;
                                          }
                                          $masters_certificate=$AttachmentsData['masters_certificate'];
                                          if($masters_certificate=="")
                                          {
                                              $masters_certificate_count=0;
                                          }
                                          else
                                          {
                                              $masters_certificate_count=1;
                                          }
                                          $masters_mark_sheet=$AttachmentsData['masters_mark_sheet'];
                                          if($masters_mark_sheet=="")
                                          {
                                              $masters_mark_sheet_count=0;
                                          }
                                          else
                                          {
                                              $masters_mark_sheet_count=1;
                                          }
                                          $graduate_certificate=$AttachmentsData['graduate_certificate'];
                                          if($graduate_certificate=="")
                                          {
                                              $graduate_certificate_count=0;
                                          }
                                          else
                                          {
                                              $graduate_certificate_count=1;
                                          }
                                          $graduate_mark_sheet=$AttachmentsData['graduate_mark_sheet'];
                                          if($graduate_mark_sheet=="")
                                          {
                                              $graduate_mark_sheet_count=0;
                                          }
                                          else
                                          {
                                              $graduate_mark_sheet_count=1;
                                          }
                                          $diploma_certificate=$AttachmentsData['diploma_certificate'];
                                          if($diploma_certificate=="")
                                          {
                                              $diploma_certificate_count=0;
                                          }
                                          else
                                          {
                                              $diploma_certificate_count=1;
                                          }
                                          $diploma_mark_sheet=$AttachmentsData['diploma_mark_sheet'];
                                          if($diploma_mark_sheet=="")
                                          {
                                              $diploma_mark_sheet_count=0;
                                          }
                                          else
                                          {
                                              $diploma_mark_sheet_count=1;
                                          }
                                          $skilled_certificate=$AttachmentsData['skilled_certificate'];
                                          if($skilled_certificate=="")
                                          {
                                              $skilled_certificate_count=0;
                                          }
                                          else
                                          {
                                              $skilled_certificate_count=1;
                                          }
                                          $hsc_certificate=$AttachmentsData['hsc_certificate'];
                                          if($hsc_certificate=="")
                                          {
                                              $hsc_certificate_count=0;
                                          }
                                          else
                                          {
                                              $hsc_certificate_count=1;
                                          }

                                          $hsc_mark_sheet=$AttachmentsData['hsc_mark_sheet'];
                                          if($hsc_mark_sheet=="")
                                          {
                                              $hsc_mark_sheet_count=0;
                                          }
                                          else
                                          {
                                              $hsc_mark_sheet_count=1;
                                          }
                                          $ssc_certificate=$AttachmentsData['ssc_certificate'];
                                          if($ssc_certificate=="")
                                          {
                                              $ssc_certificate_count=0;
                                          }
                                          else
                                          {
                                              $ssc_certificate_count=1;
                                          }
                                          $ssc_mark_sheet=$AttachmentsData['ssc_mark_sheet'];
                                          if($ssc_mark_sheet=="")
                                          {
                                              $ssc_mark_sheet_count=0;
                                          }
                                          else
                                          {
                                              $ssc_mark_sheet_count=1;
                                          }
                                          $passport_copy=$AttachmentsData['passport_copy'];
                                          if($passport_copy=="")
                                          {
                                              $passport_copy_count=0;
                                          }
                                          else
                                          {
                                              $passport_copy_count=1;
                                          }
                                          $birth_certificate=$AttachmentsData['birth_certificate'];
                                          if($birth_certificate=="")
                                          {
                                              $birth_certificate_count=0;
                                          }
                                          else
                                          {
                                              $birth_certificate_count=1;
                                          }
                                          $police_clearance_ov=$AttachmentsData['police_clearance_ov'];
                                          if($police_clearance_ov=="")
                                          {
                                              $police_clearance_ov_count=0;
                                          }
                                          else
                                          {
                                              $police_clearance_ov_count=1;
                                          }
                                          $police_clearance_bd=$AttachmentsData['police_clearance_bd'];
                                          if($police_clearance_bd=="")
                                          {
                                              $police_clearance_bd_count=0;
                                          }
                                          else
                                          {
                                              $police_clearance_bd_count=1;
                                          }
                                          $covid_certificate_ov=$AttachmentsData['covid_certificate_ov'];
                                          if($covid_certificate_ov=="")
                                          {
                                              $covid_certificate_ov_count=0;
                                          }
                                          else
                                          {
                                              $covid_certificate_ov_count=1;
                                          }
                                          $covid_certificate_bd=$AttachmentsData['covid_certificate_bd'];
                                          if($covid_certificate_bd=="")
                                          {
                                              $covid_certificate_bd_count=0;
                                          }
                                          else
                                          {
                                              $covid_certificate_bd_count=1;
                                          }

                                          $total_attachment_count=$cover_letter_count+$cv_count+$job_ex_letter_count+$employment_letter_count+$ielts_pte_certificate_count+$masters_certificate_count+$masters_mark_sheet_count+$graduate_certificate_count+$graduate_mark_sheet_count+$diploma_certificate_count+$diploma_mark_sheet_count+$skilled_certificate_count+$hsc_certificate_count+$hsc_mark_sheet_count+$ssc_certificate_count+$ssc_mark_sheet_count+$passport_copy_count+$birth_certificate_count+$police_clearance_ov_count+$police_clearance_bd_count+$covid_certificate_ov_count+$covid_certificate_bd_count;
                                          $student_visa_country=$AttachmentsData['student_visa_country'];
                                          $d_date=$AttachmentsData['d_date'];
                                          $d_time=$AttachmentsData['d_time'];
//                                          echo "<pre>";
//                                          print_r($AttachmentsData);
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $student_visa_country; ?></td>
                                            <td class="text-center">
                                                <a href="<?php echo $SiteURLAttachment; ?>" class="btn btn-outline-info btn-sm">
                                                    <?php echo $total_attachment_count; ?>
                                                </a>
                                            </td>
                                            <td class="text-center"><?php echo $d_date; ?>&nbsp;|&nbsp;<?php echo $d_time; ?></td>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?php echo $SiteURLAttachment; ?>"><i class="fa-solid fa-eye"></i>&nbsp;View</a>
                                                        <a class="dropdown-item" href="<?php echo $SiteURLAttachmentDelete; ?>" onClick="return doconfirm();"><i class="fa-solid fa-trash"></i>&nbsp;Delete</a></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
