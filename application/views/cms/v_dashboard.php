        ...
        <div class="row">
                ...
                <div class="card bg-info">
                    <div class="card-body">
                        <div class="students d-flex align-items-center justify-content-between flex-wrap">
                            ...
                            <div>
                                <img src="<?php echo base_url(); ?>others/cms/user_icon.png" width="60" height="60">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3  col-lg-6 col-sm-6">
                <div class="card bg-primary  overflow-hidden">
                    <div class="card-body">
                       <?php $SiteURLTodayApply=site_url('cms/today_apply'); ?>
                        <a href="<?php echo $SiteURLTodayApply; ?>">
                            <div class="students d-flex align-items-center justify-content-between flex-wrap">
                            <div>
                                <h4><?php echo $TodayApply; ?></h4>
                                <h5>Today Apply</h5>
                                <span>today user apply</span>
                            </div>
                            <div>
                                <img src="<?php echo base_url(); ?>others/cms/apply_icon.png" width="60" height="60">
                            </div>
                        </div>
                        </a>
                    </div>
            ...
            <div class="col-xl-3  col-lg-6 col-sm-6">
                <div class="card bg-warning  overflow-hidden">
                    <div class="card-body">
                        <?php $SiteURLTotalApply=site_url('cms/total_apply'); ?>
                        <a href="<?php echo $SiteURLTotalApply; ?>">
                            <div class="students d-flex align-items-center justify-content-between flex-wrap">
                                <div>
                                    <h4><?php echo $TotalApply; ?></h4>
                                    <h5>Total Apply</h5>
                                    <span>total user apply</span>
                                </div>
                                <div>
                                    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-xl-3  col-lg-6 col-sm-6">
                <div class="card bg-info">
                    <?php $SiteURLTotalAttachment=site_url('cms/total_attachment'); ?>
                    <a href="<?php echo $SiteURLTotalAttachment; ?>">
                      <div class="card-body">
                            <div class="students d-flex align-items-center justify-content-between flex-wrap">
                                <div>
                                    <h4><?php echo $TotalAttachment;  ?></h4>
                                    <h5>Total Attachment</h5>
                                    <span>total submit</span>
                                </div>
                                <div>
                                    <img src="<?php echo base_url(); ?>others/cms/attachment.png" width="60" height="60">
                                </div>
                            </div>
                        </div>
                    </a>
            ...
            <div class="col-xl-3  col-lg-6 col-sm-6">
                <div class="card bg-warning  overflow-hidden">
                    <?php $SiteURLTodayAttachment=site_url('cms/today_attachment'); ?>
                    <a href="<?php echo $SiteURLTodayAttachment; ?>">
                       <div class="card-body">
                        <div class="students d-flex align-items-center justify-content-between flex-wrap">
                            <div>
                                <h4><?php echo $TodayAttachment; ?></h4>
                                <h5>Today Attachment</h5>
                                <span>today submit</span>
                            </div>
                            <div>
                                <img src="<?php echo base_url(); ?>others/cms/attachment2.png" width="60" height="60">
                            </div>
                        </div>
                    </div>
                    </a>
            ...
            <div class="col-xl-3  col-lg-6 col-sm-6">
                <div class="card bg-primary  overflow-hidden">
                    <div class="card-body">
                        <?php $SiteURLTotalEligible=site_url('cms/total_eligible'); ?>
                        <a href="<?php echo $SiteURLTotalEligible; ?>">
                            <div class="students d-flex align-items-center justify-content-between flex-wrap">
                                <div>
                                    <h4><?php echo $TotalEligible; ?></h4>
                                    <h5>Total Eligible</h5>
                                    <span>eligible user</span>
                                </div>
                                <div>
                                    <img src="<?php echo base_url(); ?>others/cms/ok_icon.png" width="60" height="60">
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-xl-3  col-lg-6 col-sm-6">
                <div class="card bg-warning  overflow-hidden">
                    <div class="card-body">
                        <?php $SiteURLTotalUser=site_url('cms/total_user'); ?>
                        <a href="<?php echo $SiteURLTotalUser; ?>">
                            <div class="students d-flex align-items-center justify-content-between flex-wrap">
                                <div>
                                ...
                                <div>
                                    <img src="<?php echo base_url(); ?>others/cms/upload_icon.png" width="60" height="60">
                                </div>
                            </div>
                        </a>
                    </div>
...
<!-- http://localhost/globalconnex/cms/dashboard -->