...
<div class="page-titles">
    <ol class="breadcrumb">
        <li><h5 class="bc-title">Country Offer</h5></li>
    </ol>
    <a class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">+ Add Country</a>
...
<?php
foreach($CmsCountry as $CmsCountryData)
{
    $id=$CmsCountryData['id'];
    $image=$CmsCountryData['country_image'];
    $country_name=$CmsCountryData['country_name'];
    $details=$CmsCountryData['details'];
    ?>

    <tr>
        <td>
            <img src="<?php echo base_url(); ?>others/upload/country/<?php echo $image; ?>" width="80px" height="80px"  alt="">
        </td>
        <td><span><?php echo $country_name; ?></span></td>
        <td><span><?php echo $details; ?></span></td>
        <td>
            <?php
            $SiteURLCountryDele=site_url('admin_oparetion/country_delete/'.$id);
            $SiteURLEdit=site_url('cms/home_country_update/'.$id);
            ?>
...
<div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasExample">
    <div class="offcanvas-header">
        <h5 class="modal-title" id="#gridSystemModal">Add Country</h5>
    ...
    <div class="offcanvas-body">
        <div class="container-fluid">
                ...
                <?php echo form_open_multipart('admin_oparetion/cms_home_country', $attributes);?>
                <div class="row">
                    <div class="mb-3">
                        <label class="form-label">Country Name :</label>
                        <input type="text" name="CountryName" class="form-control" value="" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <?php
                        $SapmleImageLink=base_url()."others/upload/country/preview.jpg";
                        ?>

                        <label class="form-label">Flag Image <small>[Width:200px - Height:200px]</small></label>
                        ...
                        <div class="timeline_content_addon3">
                            <img id="output" src="<?php echo $SapmleImageLink; ?>" width="100px" height="100px" />
                        </div>
                    </div>
                </div>
                <div>
