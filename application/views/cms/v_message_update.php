            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Message Update</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            foreach($Message as $MessageData)
                            {
                                ...
                                $SapmleImageLink=base_url()."others/upload/about_message/".$image;
                            }
                            ?>
                            <?php $attributes = array('id' => '', 'class' => 'form-valide-with-icon needs-validation', 'enctype' =>'multipart/form-data');?>
                            <?php echo form_open_multipart('admin_oparetion/message_update', $attributes);?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="4" cols="50" name="Message" class="form-control" required><?php echo $message ?></textarea>
                            </div>
                            <div class="mb-3">
