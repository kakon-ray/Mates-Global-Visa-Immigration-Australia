...
<div class="content-body">
    ...
    <div class="page-titles">
        <ol class="breadcrumb">
            <li><h5 class="bc-title">Immigration Service</h5></li>
        </ol>
        <a class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">+ Add Service</a>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive active-projects style-1">
                            ...
                            <table id="empoloyees-tblwrapper" class="table-responsive">
                                ...
                                {
                                    $id=$ImmigrationData['id'];
                                    $image=$ImmigrationData['image'];
                                    $title=$ImmigrationData['title'];
                                    $text=$ImmigrationData['text'];
                                    ?>

                                    <tr>
                                        <td>
                                            <img src="<?php echo base_url(); ?>others/upload/home-service/<?php echo $image; ?>" width="80px" height="85px"  alt="">
                                        </td>
                                        <td><span><?php echo $title; ?></span></td>
                                        <td><span><?php echo $text; ?></span></td>
                                        <td>
                                            <?php
                                            $SiteURLCountryDele=site_url('admin_oparetion/service_delete/'.$id);
                                            $SiteURLEdit=site_url('cms/home_service_update/'.$id);
                                            ?>
...
<div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasExample">
    <div class="offcanvas-header">
        <h5 class="modal-title" id="#gridSystemModal">Add Service</h5>
    ...
    <div class="offcanvas-body">
        <div class="container-fluid">
            ...
            <?php echo form_open_multipart('admin_oparetion/cms_home_immigration', $attributes);?>
            <div class="row">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea rows="3" cols="40" name="Text" class="form-control" required></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <label class="form-label">Service Image <small>[Width:270px - Height:279px]</small></label>
                    ...
                    <div class="timeline_content_addon3">
                        <img id="output" src="<?php echo $SapmleImageLink; ?>" width="150px" height="155px" />
                    </div>
                </div>
            </div>
            <div>
