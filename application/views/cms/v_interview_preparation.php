...
<div class="content-body">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li><h5 class="bc-title">Job&nbsp;Recruitment</h5></li>
        </ol>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Interview&nbsp;Preparation&nbsp;Content&nbsp;Update</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            {
                                $id=$InterviewPreparationData['id'];
                            ...
                            <?php echo form_open_multipart('admin_oparetion/interview_preparation_update', $attributes);?>
