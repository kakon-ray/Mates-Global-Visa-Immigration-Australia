        ...
        <div class="col-xl-12">
            ...
            <div class="card dz-card" id="accordion-one">
                <div class="card-header flex-wrap">
                    <div>
                        <h4 class="card-title">Total Apply</h4>
                    </div>
                </div>
                <!--tab-content-->
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <label class="dropdown">
                                                    ...
                                                    <ul class="dd-menu">
                                                        <li><a href="<?php echo $SiteURLFormView; ?>"><i class="fa-solid fa-eye"></i>&nbsp;View</a></li>
                                                        <li><a href="<?php echo $SiteURLAttachment; ?>"><i class="fa-solid fa-paperclip"></i>&nbsp;Attachment</a></li>
                                                        <li class="divider"></li>
                                                        <li><a href="<?php echo $SiteURLFormView; ?>"><i class="fa-solid fa-trash"></i>&nbsp;Delete</a></li>
                                                    </ul>
