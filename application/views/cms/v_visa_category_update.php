            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Visa Category Update</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <?php echo form_open_multipart('admin_oparetion/visa_category_update', $attributes);?>
                            <input type="hidden" name="Id" value="<?php echo $id; ?>">
                            <div class="mb-3">
                                <label class="form-label">Category Name :</label>
                                <input type="text" name="CategoryName" class="form-control" value="<?php echo $category_name ?>" required>
                            </div>
                            <div class="mb-3">
