            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Country&nbsp;Serve&nbsp;Australia&nbsp;Content&nbsp;Update</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <?php echo form_open_multipart('admin_oparetion/country_australia_update', $attributes);?>
