...
<div class="content-body">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li><h5 class="bc-title">About Company</h5></li>
        </ol>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <?php
                            foreach($CmsAbout as $CmsAboutData)
                            {
                                $id=$CmsAboutData['id'];
                                $image=$CmsAboutData['image'];
                                $title=$CmsAboutData['title'];
                                $details=$CmsAboutData['details'];
                                $link=$CmsAboutData['link'];
                                $phone=$CmsAboutData['phone'];

                                $SapmleImageLink=base_url()."others/upload/about/".$image;
                            }
                            ?>
                            <?php $attributes = array('id' => '', 'class' => 'form-valide-with-icon needs-validation', 'enctype' =>'multipart/form-data');?>
                            <?php echo form_open_multipart('admin_oparetion/cms_about_update', $attributes);?>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Image : <small>[Width:712px - Height:492px]</small></label>
                                ...
                                <div class="timeline_content_addon3">
                                    <img id="output" src="<?php echo $SapmleImageLink; ?>" width="300px" height="200px" />
                                </div>
                            </div>
