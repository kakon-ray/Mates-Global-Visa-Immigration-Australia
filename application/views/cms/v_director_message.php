...
<div class="content-body">
    ...
    <div class="page-titles">
        <ol class="breadcrumb">
            <li><h5 class="bc-title">Director Message</h5></li>
        </ol>
        <a class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">+ Add Message</a>
                        ...
                        <div class="table-responsive active-projects style-1">
                            <table id="empoloyees-tblwrapper" class="table-responsive">
                                ...
                                foreach($Message as $MessageData)
                                {
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<?php echo base_url(); ?>others/upload/about_message/<?php echo $image; ?>" width="80px" height="80px"  alt="">
                                        </td>
                                        ...
                                        <td>
                                            <?php
                                            $SiteURLCountryDele=site_url('admin_oparetion/message_delete/'.$id);
                                            $SiteURLEdit=site_url('cms/director_message_update/'.$id);
                                            ?>
...
<div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasExample">
    <div class="offcanvas-header">
        <h5 class="modal-title" id="#gridSystemModal">Add Message</h5>
    ...
    <div class="offcanvas-body">
        <div class="container-fluid">
            ...
            <?php echo form_open_multipart('admin_oparetion/cms_new_message', $attributes);?>
            <div class="row">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea rows="4" cols="50" name="Message" class="form-control" required></textarea>
                </div>
