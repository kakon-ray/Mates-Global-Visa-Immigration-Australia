...
<div class="content-body">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li><h5 class="bc-title">Visa&nbsp;Consultant</h5></li>
        </ol>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Work&nbsp;Permit&nbsp;Content Update</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <?php
                            foreach($WorkPermit as $WorkPermitData)
                            {
                                $id=$WorkPermitData['id'];
                                $image=$WorkPermitData['image'];
                                $title=$WorkPermitData['title'];
                                $text=$WorkPermitData['text'];
                                $SapmleImageLink=base_url()."others/upload/common/".$image;
                            }
                            ?>
                            <?php $attributes = array('id' => '', 'class' => 'form-valide-with-icon needs-validation', 'enctype' =>'multipart/form-data');?>
                            <?php echo form_open_multipart('admin_oparetion/work_permit_update', $attributes);?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="6" cols="80" name="Text" class="form-control" required><?php echo $text ?></textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Image : <small>[Width:570px - Height:530px]</small></label>
                                ...
                                <div class="timeline_content_addon3">
                                    <img id="output" src="<?php echo $SapmleImageLink; ?>" width="220px" height="200px" />
                                </div>
