...
<?php
 foreach($CmsSlider as $CmsSliderData)
 {
     ...
     $d_date=$CmsSliderData['d_date'];
     $d_time=$CmsSliderData['d_time'];

?>

<tr>
    <td>
        <img src="<?php echo base_url(); ?>others/upload/cms/<?php echo $image; ?>" width="300" height="auto"  alt="">
    </td>
    <td><span><?php echo $title; ?></span></td>
    <td><span><?php echo $big_text; ?></span></td>
    <td><span><?php echo $small_text; ?></span></td>
<!--    <td><span>--><?php //echo $d_date; ?><!--&nbsp;--><?php //echo $d_time; ?><!--</span></td>-->

    <td>
        <?php
        $SiteURLSliderUpdate=site_url('cms/slider_update/'.$id);
        ?>
        <a href="<?php echo $SiteURLSliderUpdate ?>" class="badge badge-success light border-0">
            Update
        </a>
    </td>
</tr>
