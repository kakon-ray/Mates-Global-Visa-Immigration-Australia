            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Visa items New Zealand update</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            foreach($VisaAustralia as $VisaAustraliaData)
                            {
                                ...
                                $hrflink=$VisaAustraliaData['hrflink'];
                            ...
                            <?php echo form_open_multipart('admin_oparetion/visa_newzealand_update', $attributes);?>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="default-select  form-control wide" name="CategoryId" required>
                                    ...
                                    foreach($VisaCategory as $VisaCategoryData)
                                    {
                                        ...
                                        if($visa_category_id==$CategoryId)
                                        {
                                            ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="4" cols="50" name="Details" class="form-control" required><?php echo $details; ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Link :</label>
                                <input type="text" name="hrflink" class="form-control" value="<?php echo $hrflink; ?>"  required>
                            </div>
                            <div class="mb-3">
